...
public class MassGainWorkoutActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mass_gain_workout_activity);
        ...
        RecyclerView recyclerView = findViewById(R.id.workoutRecyclerMG);
